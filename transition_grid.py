...
def find_network_of_hijacks(starting_pattern, permitted_throws, write_to_workbook=False, workbook_name=''):
    ...
    while keep_looping:
        ...
        for pattern in new_patterns:
            hijack = programming.generate_hijacks(pattern, permitted_throws)
            hijack +=  programming.generate_hijacks(pattern[1:]+pattern[:1], permitted_throws)
